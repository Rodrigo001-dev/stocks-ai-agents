...
get_news = Task(
  description=f"Take the stock and always include BTC to it (if not request). Use the search tool to search each once individually. The current date is {datetime.now()}. Compose the results into a helpfull report",
